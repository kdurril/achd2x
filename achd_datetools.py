...
def date_iso(d: dt.datetime) -> str:
...
def date_iter(start=dt.date.today(), end=dt.date.today()+dt.timedelta(days=1)) -> dt.date:
    "date generator"
...
def date_gen(start=(2017,8,17), end=(2017,8,18)) -> dt.date:
    "datetime counter"
